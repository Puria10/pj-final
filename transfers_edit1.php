...
$result = mysqli_query($link, "SELECT * FROM `news_asli1` WHERE id=$id");
mysqli_close($link);
...
<form action="transfers_edit_action.php" method="post" enctype="multipart/form-data" class="row m-2">
