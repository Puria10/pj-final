...
if ($id > 0) {
    $query = "UPDATE `news_asli` SET `title`='$title', `text`='$text', `imageurl`='$imageurl' WHERE `id`=$id";
} else {
    $query = "INSERT INTO `news_asli`(`title`, `text`, `imageurl`) VALUES ('$title','$text','$imageurl')";
}
