...
$result = mysqli_query($link, "SELECT * FROM `news_asli` WHERE id=$id");
mysqli_close($link);
...
<form action="footballiran_edit_action.php" method="post" enctype="multipart/form-data" class="row m-2">
